  ...
  return (
    <div>
      ...
      className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white'>
        Best online plateform for education.</h1>
        <p data-aos="fade-left" data-aos-delay='150' className='mt-6 text-sm md:text-base text-white text-opacity-60'>
            Offer personalized learning paths based on user preferences,
             progress, and performance, allowing learners to follow a 
             customized educational journey
        </p>
        <div className='mt-8 flex items-center space-x-4'>
            <button data-aos="zoom-in" data-aos-delay='300'
             className='button__cls bg-green-700 hover:bg-green-900'>Get Started</button>
            <button data-aos="fade-left" data-aos-delay='450'
             className='button__cls bg-yellow-700 hover:bg-yellow-900'>Learn More</button>
        </div>
        {/* stats */}
        <div className='flex items-center flex-wrap space-x-16 mt-8'>
            <div data-aos="fade-up" data-aos-delay='600'>
                <p className='md:text-xl lg:text-base text-white font-bold'>260+</p>
             ...
             <div data-aos="fade-up" data-aos-delay='750'>
                <p className='md:text-xl lg:text-base text-white font-bold'>2260+</p>
             ...
             <div data-aos="fade-up" data-aos-delay='900'>
                <p className='md:text-xl lg:text-base text-white font-bold'>60+</p>
